// завдання 4
// дуже складна реалізація, можна зробити набагато простіше, опишу логіку:
// - ініціалізуєш рефи 
// - вішаш прослуховувачі події клік для кнопок 
// - в функції прослуховувача події клік для кнопки 
// береш старе значення з інпуту потім інкрементиш його або декрементиш 
// в залежності від типу кнопки і назад записуєш в інпут
// - все
